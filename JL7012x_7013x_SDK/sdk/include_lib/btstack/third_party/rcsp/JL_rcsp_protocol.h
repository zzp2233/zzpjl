...
enum {
    ...
    JL_OPCODE_APP_RECORDING = 0x04,
    JL_OPCODE_APP_RECORD_END = 0x05,
    ...
    JL_OPCODE_REQUEST_EXCEPTION_INFO = 0x29,

    JL_OPCODE_MASS_DATA = 0x30,
    JL_OPCODE_AI_DIAL = 0x32,
    JL_OPCODE_COMMON_INFO_SET = 0x33,
    ...
    JL_OPTCODE_DEVICE_CONFIG_GET = 0XD9,
    JL_OPTCODE_DEVICE_REQUEST_DATA = 0XE5,
