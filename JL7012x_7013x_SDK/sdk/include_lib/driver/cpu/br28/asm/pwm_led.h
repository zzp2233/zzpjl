...
#define CFG_LED0_LIGHT						380  	//10 ~ 500, 值越大, (红灯)亮度越高 3.2V
#define CFG_LED1_LIGHT						380  	//10 ~ 500, 值越大, (蓝灯)亮度越高 3.2V

#define CFG_LED0_HIGHT_LIGHT				440  	//10 ~ 500, 值越大, (红灯)亮度越高 3.6V
#define CFG_LED1_HIGHT_LIGHT				440  	//10 ~ 500, 值越大, (蓝灯)亮度越高 3.6V

#define CFG_SINGLE_FAST_FLASH_FREQ			1000		//LED单独快闪速度, ms闪烁一次(100 ~ 1000)
#define CFG_SINGLE_FAST_LIGHT_TIME 			500  	//单灯快闪灯亮持续时间, 单位ms
...
enum pwm_led_mode {
    ...
    PWM_LED_MODE2ALL_ON,              	//mode2: 全亮等级2
