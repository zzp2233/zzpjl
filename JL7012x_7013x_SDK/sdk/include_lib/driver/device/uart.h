...
int uart_init_2(int uart_num, const struct uart_platform_data *data);


void uart_dma_rx_init(int uart_num, u8 *dma_buf, int buf_size);


void uart_putbyte(int uart_num, char c);


u8 uart_getbyte(int uart_num);
